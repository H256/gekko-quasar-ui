...
export default [
  {
    ...
    children: [
      ...
      { path: 'live-gekkos/stratrunner/:id', component: () => import('components/gekko/singleStratrunner')},
      { path: 'live-gekkos/watcher/:id', component: () => import('components/gekko/singleWatcher')},
